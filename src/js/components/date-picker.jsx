...
function setupDatePicker() {
    ...
    function restyleButton() {
        ...
        newButton.className += "calendarButton";
        document.getElementsByClassName("date-picker-control")[0].append(newButton);
        document.getElementsByClassName("fontIcon")[0].remove();
    };

    datePickerController.createDatePicker({
        // Associate the text input to a DD/MM/YYYY date format
        formElements: { "dpDemo": "%m/%d/%Y" },
        noFadeEffect: true,
        staticPos: false,
        labelText: "Start Date",
        callbackFunctions: {
            "dombuttoncreate": [ restyleButton ]
        }
    });
}
*/
